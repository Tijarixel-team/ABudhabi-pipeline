...
export function Footer() {
  ...
  return (
    <footer className="relative z-10 overflow-hidden bg-logo-bg text-white">
      <StaggerReveal className="section-shell relative grid gap-12 py-16 lg:grid-cols-[1.15fr_0.65fr_1fr] lg:py-20">
        <StaggerItem>
          <div>
            <BrandWordmark />
      ...
      <div className="relative border-t border-white/10 py-5">
        <ScrollReveal variant="softFade" className="section-shell flex flex-col justify-between gap-3 text-xs text-white/58 sm:flex-row">
