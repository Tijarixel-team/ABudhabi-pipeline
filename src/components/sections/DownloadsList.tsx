  ...
  return (
    <div>
      ...
      <div className="grid gap-4">
        {filtered.map((item) => (
          <a key={item.title} href={item.href} className="grid gap-4 rounded-[var(--radius)] border border-secondary/15 bg-white p-5 shadow-sm transition hover:border-secondary/40 md:grid-cols-[1fr_auto]">
            <div>
