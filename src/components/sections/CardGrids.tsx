  ...
  return (
    <div className="grid gap-x-7 gap-y-12 md:grid-cols-2 lg:grid-cols-3">
      {industries.map((industry) => (
        <article key={industry.slug} className="group">
  ...
  return (
    <div className="border-t border-secondary/20">
      {capabilities.map((capability, index) => (
        <article key={capability.title} className="grid gap-4 border-b border-secondary/20 py-7 md:grid-cols-[48px_1fr] md:gap-6">
...
export function CertificationGrid({ certifications }: { certifications: Certification[] }) {
  return (
    <div className="grid border-t border-secondary/20 md:grid-cols-2">
      {certifications.map((certification) => (
        <article key={certification.title} className="border-b border-secondary/20 py-8 md:px-7 md:odd:border-r md:odd:pl-0">
